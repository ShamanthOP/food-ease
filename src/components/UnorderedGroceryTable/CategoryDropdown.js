...
function CategoryDropdown({ list, title, onChange, grocery }) {
    ...
    return (
        <div id="unordered-dd-wrapper">
            <div
                id={`unordered-dd-header_${listOpen ? "is-open" : ""}`}
            ...
            {listOpen && (
                <ul id="unordered-dd-list" style={{ marginTop: "0px" }}>
                    {Object.keys(list).map((key) => {
                        return (
                            <li
                                key={key}
                                id="unordered-dd-list-item"
                    ...
                    >
                        <p id="unordered-dd-list-text">New category</p>
                    </li>
                </ul>
            )}
        </div>
