...
const LoginPage = (props) => {
    ...
    const startLoginWithEmailAndPassword = useStoreActions(
        (actions) => actions.auth.startLoginWithEmailAndPassword
    );
    const startLoginAnonymously = useStoreActions(
        (actions) => actions.auth.startLoginAnonymously
    );
    const errorMessage = useStoreState((state) => state.auth.errorMessage);
    const setErrorMessage = useStoreActions(
        (actions) => actions.auth.setErrorMessage
    );
        ...
        <div id="login-outer-container">
            {loading ? (
                ...
                <div id="login-container">
                    ...
                    <div id="login-label">Or login with one of the others</div>

                    <div onClick={beginLogin} id="login-with-google-container">
                        <div id="login-with-google-inner-container">
                            <img id="google-logo" alt="Google" src={google} />
                            Login with google
                        </div>
                    </div>
                    <div
                    ...
                    >
                        <div id="login-with-anon-inner-container">
                            <Anon id="anon-logo" alt="Anonymous" src={Anon} />
                            Login anonymously
                        </div>
                    </div>
