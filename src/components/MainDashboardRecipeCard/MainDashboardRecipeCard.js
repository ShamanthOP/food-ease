...
const MainDashboardRecipeCard = ({
    ...
    return (
        <div>
            {localRecip && recipe === "" ? (
                <div
                    className="main-dashboard-recipe-card"
                ...
                >
                    <div className="main-dashboard-recipe-card__container">
                        <div className="main-dashboard-recipe-card__header">
                            <h4 id="main-dashboard-recipe-card__header-text">
                                {day}
                            </h4>
                        </div>
                ...
                <div
                    style={{ animationName: animName }}
                    className="main-dashboard-recipe-card"
                    onMouseEnter={() => setViewHiddenButton(!viewHiddenButton)}
                    onMouseLeave={() => setViewHiddenButton(!viewHiddenButton)}
                >
                    <div className="main-dashboard-recipe-card__container">
                        <div className="main-dashboard-recipe-card__header">
                            <h4 id="main-dashboard-recipe-card__header-text">
