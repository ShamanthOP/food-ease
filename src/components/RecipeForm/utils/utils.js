export const updateName = ({ e, recipeid, name, updateRecipe, setError }) => {
    e.preventDefault();
    if (name.trim() === "") {
        setError(true);
    } else {
...
export const updateLink = ({ e, recipeid, link, updateRecipe, setError }) => {
    e.preventDefault();
    if (link.trim() === "") {
        return;
    } else {
...
export const updateCategory = ({ e, recipeid, categoryid, updateRecipe }) => {
    updateRecipe({
