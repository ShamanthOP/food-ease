    ...
    return (
        <div id="recipe-form-container">
            <div id="recipe-form-title-container">
                <div id="recipe-form-title-back-container">
                    <div id="recipe-form-title-back-inner-container">
                        <LeftArrow
                            id="recipe-form-title-back-icon"
            ...
            <div id="recipe-form-inner-container">
                ...
                <div id="recipe-form-item-container">
                    <div id="recipe-form-label">Link to recipe</div>
                    <form onSubmit={handleUpdateLink} onBlur={handleUpdateLink}>
                        <input
                            style={{
                                borderBottom:
                ...
                <div id="recipe-form-item-container">
                    <div id="recipe-form-label">Recipe category</div>
                    <CategoryDropdown
